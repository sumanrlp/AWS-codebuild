...
module "vpc" {
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app?ref=v0.22.3"
  ...
  public_route_table_custom_tags              = var.public_route_table_custom_tags
  private_app_route_table_custom_tags         = var.private_app_route_table_custom_tags
  private_persistence_route_table_custom_tags = var.private_persistence_route_table_custom_tags
...
module "vpc_peering_connection" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-peering?ref=v0.22.3"
...
module "dns_mgmt_to_app" {
  source           = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-dns-forwarder?ref=v0.22.3"
...
module "vpc_network_acls" {
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app-network-acls?ref=v0.22.3"
